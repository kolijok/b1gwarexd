...
//#include "Ikaros_Framework\Inventory_changer.h"
enum ItemQuality
{
...
public:
	...
	{
		auto v15 = (DWORD*)GetItemaSchema();
		auto v16 = *(DWORD *)(v15[72] + 4 * index);

		static auto fnSetDynamicAttributeValue
			= reinterpret_cast<int(__thiscall*)(CEconItem*, DWORD, void*)>(
				Utilities::Memory::FindPatternIDA("client.dll", "55 8B EC 83 E4 F8 83 EC 3C 53 8B 5D 08 56 57 6A 00")
				);

		fnSetDynamicAttributeValue(this, v16, &val);
	}
	template<typename TYPEa>
	void getAttributeValue(int index, TYPEa val)
	{
		auto v15 = (DWORD*)GetItemaSchema();
		auto v16 = *(DWORD *)(v15[72] + 4 * index);

		static auto fnSetDynamicAttributeValue
			= reinterpret_cast<int(__thiscall*)(CEconItem*, DWORD)>(
				Utilities::Memory::FindPatternIDA("client.dll", "55 8B EC 83 E4 F8 83 EC 3C 53 8B 5D 08 56 57 6A 00")
				);

		val = fnSetDynamicAttributeValue(this, v16);
	}
};